...
def crypto_predictor(symbol_crypto,crypto_option):
    ...
    #First of all, let's check we have internet to get the latest historical prices
    ...
    try:
        ...
        st.markdown('Internet is needed to get historical prices and calculate the prediction.')